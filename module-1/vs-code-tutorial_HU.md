...
> **Important Note:** These shortcuts are shown for **US English (QWERTY)** keyboard layout. If you're using a different keyboard layout (e.g., Hungarian, German, French), some shortcuts may be different. You can:
>
